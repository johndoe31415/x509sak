...
# Create a CSR
../x509sak.py createcsr -f client1.key client1.csr

# Create another CSR with Subject Alternative Names
../x509sak.py createcsr -g ecc:secp256r1 --san-dns foobar --san-ip 1.2.3.4 -s "/CN=moo koo" -f client2.key client2.csr
...
../x509sak.py createcsr --create-crt foo_ca -g ecc:secp256r1 --san-dns foobar --san-ip 1.2.3.4 -s "/CN=moo koo 3" -f client3.key client3.crt
...
../x509sak.py createcsr --create-crt foo_ca -g ecc:secp256r1 --san-dns foobar --san-ip 1.2.3.4 --extension "1.2.3.4.5=DER:00:11:22:33" -s "/CN=moo koo 4" -f client3.key client4.crt
...
../x509sak.py createcsr --create-crt foo_ca -g rsa:1024 --template tls-server --san-dns foobar --san-ip 1.2.3.4 --extension "1.2.3.4.5=DER:00:11:22:33" -s "/CN=moo koo 5" -f client3.key client5.crt
