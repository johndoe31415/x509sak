...
class JudgementCode(enum.Enum):
	...
	Cert_X509Ext_CRLDistributionPoints_PointName_Relative = ("CRL Distribution Points extension", "distribution point name uses relative distinguished name")
	Cert_X509Ext_CRLDistributionPoints_PointName_RelativeToMultipleDNs = ("CRL Distribution Points extension", "distribution point name uses relative distinguished name even though multiple CRL issuer DNs present")
	...
	Cert_X509Ext_CRLDistributionPoints_IssuerName_EmptyValue = ("CRL Distribution Points extension", "distribution point issuer contains empty value")
	Cert_X509Ext_CRLDistributionPoints_IssuerName_BadEmail = ("CRL Distribution Points extension", "distribution point issuer contains invalid email")
	Cert_X509Ext_CRLDistributionPoints_IssuerName_BadURI = ("CRL Distribution Points extension", "distribution point issuer contains invalid URI")
	Cert_X509Ext_CRLDistributionPoints_IssuerName_UncommonURIScheme = ("CRL Distribution Points extension", "distribution point issuer contains uncommon URI scheme")
	Cert_X509Ext_CRLDistributionPoints_IssuerName_UncommonIdentifier = ("CRL Distribution Points extension", "distribution point issuer contains uncommon identifier")
	Cert_X509Ext_CertificateTransparencyPoison_IsPrecertificate = ("Certificate Transparency Precertificate Poison", "not a certificate, but precertificate")
	Cert_X509Ext_CertificateTransparencyPoison_NotCritical = ("Certificate Transparency Precertificate Poison", "extension not marked as critical")
	Cert_X509Ext_CertificateTransparencyPoison_InvalidPayload = ("Certificate Transparency Precertificate Poison", "extnValue is not NULL")
