...
class JudgementCode(enum.Enum):
	...
	Cert_X509Ext_AuthorityKeyIdentifier_CAName_BadDNSName_SingleLabel = ("X.509 AuthorityKeyIdentifier CA name", "domain name contains only of single label")
	...
	Cert_X509Ext_IssuerAltName_BadDNSName_SingleLabel = ("X.509 IssuerAlternativeName", "domain name contains only of single label")
	...
	Cert_X509Ext_SubjectAltName_BadDNSName_SingleLabel = ("X.509 SubjectAlternativeName", "domain name contains only of single label")
