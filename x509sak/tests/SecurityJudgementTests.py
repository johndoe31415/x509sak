...
class SecurityJudgementTests(BaseTest):
	def test_simple(self):
		judgement = SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar!", bits = 0)
		self.assertEqual(judgement.code, JudgementCode.RSA_Parameter_Field_Not_Null)
	...
	def test_judgements(self):
		...
		judgements += SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar! 1", verdict = Verdict.HIGH, commonness = Commonness.UNUSUAL)
		self.assertTrue(judgements.uniform_topic)
		self.assertEqual(len(judgements), 1)

		judgements += SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar! 2", verdict = Verdict.BROKEN, commonness = Commonness.COMMON)
		self.assertTrue(judgements.uniform_topic)
	...
	def test_serialize_judgements(self):
		judgements = SecurityJudgements()
		judgements += SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar! 1", verdict = Verdict.HIGH, commonness = Commonness.UNUSUAL)
		judgements += SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar! 2", verdict = Verdict.HIGH, commonness = Commonness.UNUSUAL)
	...
	def test_append_judgements(self):
		...
		sub += SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar! 1", verdict = Verdict.HIGH, commonness = Commonness.UNUSUAL)
		sub += SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar! 2", verdict = Verdict.HIGH, commonness = Commonness.UNUSUAL)
		judgements += sub
		self.assertEqual(len(judgements), 2)

		judgements += SecurityJudgement(code = JudgementCode.RSA_Parameter_Field_Not_Null, text = "Foo Bar! 3", verdict = Verdict.HIGH, commonness = Commonness.UNUSUAL)
